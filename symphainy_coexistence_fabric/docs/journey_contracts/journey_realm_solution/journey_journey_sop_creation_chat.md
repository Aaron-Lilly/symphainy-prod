# Journey Contract: SOP Creation via Chat

**Journey:** SOP Creation via Chat  
**Journey ID:** `journey_journey_sop_creation_chat`  
...
### Intents in Journey
1. `initiate_sop_wizard` - Step 1: [Intent description - to be detailed based on implementation]
2. `chat_with_journey_agent` - Step 2: [Intent description - to be detailed based on implementation]
3. `save_sop_from_chat` - Step 3: [Intent description - to be detailed based on implementation]
