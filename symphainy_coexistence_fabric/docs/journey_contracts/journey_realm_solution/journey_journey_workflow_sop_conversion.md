# Journey Contract: Workflow/SOP Conversion

**Journey:** Workflow/SOP Conversion  
**Journey ID:** `journey_journey_workflow_sop_conversion`  
...
### Intents in Journey
1. `create_workflow_from_sop` - Step 1: [Intent description - to be detailed based on implementation]
2. `generate_sop_from_workflow` - Step 2: [Intent description - to be detailed based on implementation]
