# Journey Contract: Workflow/SOP Selection & Visualization

**Journey:** Workflow/SOP Selection & Visualization  
**Journey ID:** `journey_journey_workflow_sop_visualization`  
...
### Intents in Journey
1. `select_workflow` - Step 1: [Intent description - to be detailed based on implementation]
2. `select_sop` - Step 2: [Intent description - to be detailed based on implementation]
3. `generate_visualization` - Step 3: [Intent description - to be detailed based on implementation]
