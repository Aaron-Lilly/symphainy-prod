# Journey Contract: Platform Introduction

**Journey:** Platform Introduction  
**Journey ID:** `journey_coexistence_introduction`  
...
### Intents in Journey
1. `introduce_platform` - Step 1: [Intent description]
2. `show_solution_catalog` - Step 2: [Intent description]
3. `explain_coexistence` - Step 3: [Intent description]
