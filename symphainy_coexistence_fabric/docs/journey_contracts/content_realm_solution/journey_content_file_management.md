# Journey Contract: File Management

**Journey:** File Management  
**Journey ID:** `journey_content_file_management`  
...
### Intents in Journey
1. `list_artifacts` - Step 1: [Intent description]
2. `get_artifact_metadata` - Step 2: [Intent description]
3. `archive_file` - Step 3: [Intent description]
...
- Artifacts as defined by journey intents

### Journey Completion Definition

**Journey is considered complete when:**

* All intents execute successfully
