# Journey Contract: Deterministic Embedding Creation

**Journey:** Deterministic Embedding Creation  
**Journey ID:** `journey_content_deterministic_embedding`  
...
### Intents in Journey
1. `create_deterministic_embeddings` - Step 1: [Intent description]
2. `save_embeddings` - Step 2: [Intent description]
