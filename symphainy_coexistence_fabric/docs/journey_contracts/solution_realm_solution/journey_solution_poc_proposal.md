...
### Intents in Journey
1. `create_poc_proposal` - Step 1: [Intent description - to be detailed based on implementation]
2. `generate_poc_description` - Step 2: [Intent description - to be detailed based on implementation]
3. `save_poc_proposal` - Step 3: [Intent description - to be detailed based on implementation]
