# Intent Contract: generate_visualization

**Intent:** generate_visualization  
**Intent Type:** `generate_visualization`  
**Journey:** Journey Journey Workflow Sop Visualization (`journey_journey_workflow_sop_visualization`)  
**Realm:** Journey Realm  
**Status:** IN PROGRESS  
**Priority:** PRIORITY 1
...
- **Produced By:** `{ intent: "generate_visualization", execution_id: "<execution_id>" }`
...
```json
{
  ...
  "error_code": "ERROR_CODE",
  "execution_id": "exec_abc123",
  "intent_type": "generate_visualization"
}
```
