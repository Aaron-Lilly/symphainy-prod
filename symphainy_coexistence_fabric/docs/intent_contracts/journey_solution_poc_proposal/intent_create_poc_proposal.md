# Intent Contract: create_poc_proposal

**Intent:** create_poc_proposal  
**Intent Type:** `create_poc_proposal`  
...
- **Produced By:** `{ intent: "create_poc_proposal", execution_id: "<execution_id>" }`
...
```json
{
  ...
  "error_code": "ERROR_CODE",
  "execution_id": "exec_abc123",
  "intent_type": "create_poc_proposal"
}
```
