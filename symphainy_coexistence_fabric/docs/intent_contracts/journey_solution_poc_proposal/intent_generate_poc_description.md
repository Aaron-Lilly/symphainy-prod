# Intent Contract: generate_poc_description

**Intent:** generate_poc_description  
**Intent Type:** `generate_poc_description`  
**Journey:** Journey Solution Poc Proposal (`journey_solution_poc_proposal`)  
...
- **Produced By:** `{ intent: "generate_poc_description", execution_id: "<execution_id>" }`
...
```json
{
  ...
  "error_code": "ERROR_CODE",
  "execution_id": "exec_abc123",
  "intent_type": "generate_poc_description"
}
```
