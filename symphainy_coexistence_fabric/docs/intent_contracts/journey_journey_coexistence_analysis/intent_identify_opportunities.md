# Intent Contract: identify_opportunities

**Intent:** identify_opportunities  
**Intent Type:** `identify_opportunities`  
**Journey:** Journey Journey Coexistence Analysis (`journey_journey_coexistence_analysis`)  
**Realm:** Journey Realm  
**Status:** IN PROGRESS  
**Priority:** PRIORITY 1
...
- **Produced By:** `{ intent: "identify_opportunities", execution_id: "<execution_id>" }`
...
```json
{
  ...
  "error_code": "ERROR_CODE",
  "execution_id": "exec_abc123",
  "intent_type": "identify_opportunities"
}
```
