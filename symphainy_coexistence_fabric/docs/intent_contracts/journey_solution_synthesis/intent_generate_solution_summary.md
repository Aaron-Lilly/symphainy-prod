# Intent Contract: generate_solution_summary

**Intent:** generate_solution_summary  
**Intent Type:** `generate_solution_summary`  
...
- **Produced By:** `{ intent: "generate_solution_summary", execution_id: "<execution_id>" }`
...
```json
{
  ...
  "error_code": "ERROR_CODE",
  "execution_id": "exec_abc123",
  "intent_type": "generate_solution_summary"
}
```
