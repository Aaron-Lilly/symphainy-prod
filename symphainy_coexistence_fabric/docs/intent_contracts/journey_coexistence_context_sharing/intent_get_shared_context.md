# Intent Contract: get_shared_context

**Intent:** get_shared_context  
**Intent Type:** `get_shared_context`  
...
### Purpose
Retrieve shared context for agent
...
- **Produced By:** `{ intent: "get_shared_context", execution_id: "<execution_id>" }`
...
```json
{
  ...
  "error_code": "ERROR_CODE",
  "execution_id": "exec_abc123",
  "intent_type": "get_shared_context"
}
```
