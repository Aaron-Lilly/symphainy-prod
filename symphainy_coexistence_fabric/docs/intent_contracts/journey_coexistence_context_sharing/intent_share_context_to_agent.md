# Intent Contract: share_context_to_agent

**Intent:** share_context_to_agent  
**Intent Type:** `share_context_to_agent`  
**Journey:** Agent Context Sharing (`journey_coexistence_context_sharing`)  
...
### Purpose
Share conversation context when switching agents
...
- **Produced By:** `{ intent: "share_context_to_agent", execution_id: "<execution_id>" }`
...
```json
{
  ...
  "error_code": "ERROR_CODE",
  "execution_id": "exec_abc123",
  "intent_type": "share_context_to_agent"
}
```
