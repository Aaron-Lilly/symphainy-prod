# Intent Contract: merge_agent_contexts

**Intent:** merge_agent_contexts  
**Intent Type:** `merge_agent_contexts`  
...
- **Produced By:** `{ intent: "merge_agent_contexts", execution_id: "<execution_id>" }`
...
```json
{
  ...
  "error_code": "ERROR_CODE",
  "execution_id": "exec_abc123",
  "intent_type": "merge_agent_contexts"
}
```
