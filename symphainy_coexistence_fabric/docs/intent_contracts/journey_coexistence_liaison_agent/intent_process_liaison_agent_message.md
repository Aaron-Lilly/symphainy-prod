# Intent Contract: process_liaison_agent_message

**Intent:** process_liaison_agent_message  
**Intent Type:** `process_liaison_agent_message`  
...
### Purpose
Process user message, generate response, optionally call pillar MCP tools
...
- **Produced By:** `{ intent: "process_liaison_agent_message", execution_id: "<execution_id>" }`
