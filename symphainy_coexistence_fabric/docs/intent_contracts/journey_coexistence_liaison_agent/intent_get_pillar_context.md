# Intent Contract: get_pillar_context

**Intent:** get_pillar_context  
**Intent Type:** `get_pillar_context`  
...
### Purpose
Retrieve pillar-specific context for Liaison Agent
...
- **Produced By:** `{ intent: "get_pillar_context", execution_id: "<execution_id>" }`
...
```json
{
  ...
  "error_code": "ERROR_CODE",
  "execution_id": "exec_abc123",
  "intent_type": "get_pillar_context"
}
```
