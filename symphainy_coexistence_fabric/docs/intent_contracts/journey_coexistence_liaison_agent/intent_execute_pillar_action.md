# Intent Contract: execute_pillar_action

**Intent:** execute_pillar_action  
**Intent Type:** `execute_pillar_action`  
...
### Purpose
Execute pillar-specific action via pillar orchestrator MCP tool
...
- **Produced By:** `{ intent: "execute_pillar_action", execution_id: "<execution_id>" }`
...
```json
{
  ...
  "error_code": "ERROR_CODE",
  "execution_id": "exec_abc123",
  "intent_type": "execute_pillar_action"
}
```
