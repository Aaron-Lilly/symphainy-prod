# Intent Contract: initiate_guided_discovery

**Intent:** initiate_guided_discovery  
**Intent Type:** `initiate_guided_discovery`  
**Journey:** Journey Insights Data Interpretation (`journey_insights_data_interpretation`)  
...
- **Produced By:** `{ intent: "initiate_guided_discovery", execution_id: "<execution_id>" }`
...
```json
{
  ...
  "error_code": "ERROR_CODE",
  "execution_id": "exec_abc123",
  "intent_type": "initiate_guided_discovery"
}
```
