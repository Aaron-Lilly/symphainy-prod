# Intent Contract: identify_patterns

**Intent:** identify_patterns  
**Intent Type:** `identify_patterns`  
...
- **Produced By:** `{ intent: "identify_patterns", execution_id: "<execution_id>" }`
