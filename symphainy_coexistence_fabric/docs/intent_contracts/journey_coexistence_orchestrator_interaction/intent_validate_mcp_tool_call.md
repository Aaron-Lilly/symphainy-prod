# Intent Contract: validate_mcp_tool_call

**Intent:** validate_mcp_tool_call  
**Intent Type:** `validate_mcp_tool_call`  
**Journey:** Agent-Orchestrator Interaction (`journey_coexistence_orchestrator_interaction`)  
...
### Purpose
Validate MCP tool call against governance (before execution)
...
- **Produced By:** `{ intent: "validate_mcp_tool_call", execution_id: "<execution_id>" }`
...
```json
{
  ...
  "error_code": "ERROR_CODE",
  "execution_id": "exec_abc123",
  "intent_type": "validate_mcp_tool_call"
}
```
