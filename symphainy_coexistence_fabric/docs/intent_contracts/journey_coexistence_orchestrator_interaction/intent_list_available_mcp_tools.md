# Intent Contract: list_available_mcp_tools

**Intent:** list_available_mcp_tools  
**Intent Type:** `list_available_mcp_tools`  
...
### Purpose
List available orchestrator MCP tools for agent
...
- **Produced By:** `{ intent: "list_available_mcp_tools", execution_id: "<execution_id>" }`
