# Intent Contract: call_orchestrator_mcp_tool

**Intent:** call_orchestrator_mcp_tool  
**Intent Type:** `call_orchestrator_mcp_tool`  
...
### Purpose
Call orchestrator MCP tool with parameters
...
- **Produced By:** `{ intent: "call_orchestrator_mcp_tool", execution_id: "<execution_id>" }`
