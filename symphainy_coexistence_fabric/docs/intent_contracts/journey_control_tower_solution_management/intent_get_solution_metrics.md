# Intent Contract: get_solution_metrics

**Intent:** get_solution_metrics  
**Intent Type:** `get_solution_metrics`  
**Journey:** Journey Control Tower Solution Management (`journey_control_tower_solution_management`)  
...
- **Produced By:** `{ intent: "get_solution_metrics", execution_id: "<execution_id>" }`
...
```json
{
  ...
  "error_code": "ERROR_CODE",
  "execution_id": "exec_abc123",
  "intent_type": "get_solution_metrics"
}
```
