# Intent Contract: get_artifact_metadata

**Intent:** get_artifact_metadata  
**Intent Type:** `get_artifact_metadata`  
...
- **Produced By:** `{ intent: "get_artifact_metadata", execution_id: "<execution_id>" }`
...
```json
{
  ...
  "error_code": "ERROR_CODE",
  "execution_id": "exec_abc123",
  "intent_type": "get_artifact_metadata"
}
```
