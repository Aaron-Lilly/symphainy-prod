# Intent Contract: get_solution_registry_status

**Intent:** get_solution_registry_status  
**Intent Type:** `get_solution_registry_status`  
**Journey:** Journey Control Tower Monitoring (`journey_control_tower_monitoring`)  
...
- **Produced By:** `{ intent: "get_solution_registry_status", execution_id: "<execution_id>" }`
...
```json
{
  ...
  "error_code": "ERROR_CODE",
  "execution_id": "exec_abc123",
  "intent_type": "get_solution_registry_status"
}
```
