# Intent Contract: save_embeddings

**Intent:** save_embeddings  
**Intent Type:** `save_embeddings`  
...
- **Produced By:** `{ intent: "save_embeddings", execution_id: "<execution_id>" }`
