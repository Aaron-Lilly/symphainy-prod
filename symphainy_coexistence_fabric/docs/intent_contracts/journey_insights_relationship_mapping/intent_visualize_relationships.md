# Intent Contract: visualize_relationships

**Intent:** visualize_relationships  
**Intent Type:** `visualize_relationships`  
...
- **Produced By:** `{ intent: "visualize_relationships", execution_id: "<execution_id>" }`
...
```json
{
  ...
  "error_code": "ERROR_CODE",
  "execution_id": "exec_abc123",
  "intent_type": "visualize_relationships"
}
```
