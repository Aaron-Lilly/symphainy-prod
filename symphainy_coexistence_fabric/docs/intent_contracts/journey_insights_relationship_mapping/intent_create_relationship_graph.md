# Intent Contract: create_relationship_graph

**Intent:** create_relationship_graph  
**Intent Type:** `create_relationship_graph`  
**Journey:** Journey Insights Relationship Mapping (`journey_insights_relationship_mapping`)  
...
- **Produced By:** `{ intent: "create_relationship_graph", execution_id: "<execution_id>" }`
...
```json
{
  ...
  "error_code": "ERROR_CODE",
  "execution_id": "exec_abc123",
  "intent_type": "create_relationship_graph"
}
```
