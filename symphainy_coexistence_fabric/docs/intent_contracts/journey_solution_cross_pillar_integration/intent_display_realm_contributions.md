# Intent Contract: display_realm_contributions

**Intent:** display_realm_contributions  
**Intent Type:** `display_realm_contributions`  
...
- **Produced By:** `{ intent: "display_realm_contributions", execution_id: "<execution_id>" }`
...
```json
{
  ...
  "error_code": "ERROR_CODE",
  "execution_id": "exec_abc123",
  "intent_type": "display_realm_contributions"
}
```
