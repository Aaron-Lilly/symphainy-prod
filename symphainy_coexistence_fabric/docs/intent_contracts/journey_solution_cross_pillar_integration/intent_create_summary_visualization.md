# Intent Contract: create_summary_visualization

**Intent:** create_summary_visualization  
**Intent Type:** `create_summary_visualization`  
**Journey:** Journey Solution Cross Pillar Integration (`journey_solution_cross_pillar_integration`)  
...
- **Produced By:** `{ intent: "create_summary_visualization", execution_id: "<execution_id>" }`
...
```json
{
  ...
  "error_code": "ERROR_CODE",
  "execution_id": "exec_abc123",
  "intent_type": "create_summary_visualization"
}
```
