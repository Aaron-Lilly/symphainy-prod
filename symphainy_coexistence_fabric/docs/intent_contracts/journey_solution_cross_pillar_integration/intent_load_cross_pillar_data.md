# Intent Contract: load_cross_pillar_data

**Intent:** load_cross_pillar_data  
**Intent Type:** `load_cross_pillar_data`  
...
- **Produced By:** `{ intent: "load_cross_pillar_data", execution_id: "<execution_id>" }`
...
```json
{
  ...
  "error_code": "ERROR_CODE",
  "execution_id": "exec_abc123",
  "intent_type": "load_cross_pillar_data"
}
```
