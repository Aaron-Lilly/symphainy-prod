# Intent Contract: create_workflow_from_sop

**Intent:** create_workflow_from_sop  
**Intent Type:** `create_workflow_from_sop`  
...
- **Produced By:** `{ intent: "create_workflow_from_sop", execution_id: "<execution_id>" }`
...
```json
{
  ...
  "error_code": "ERROR_CODE",
  "execution_id": "exec_abc123",
  "intent_type": "create_workflow_from_sop"
}
```
