# Intent Contract: generate_sop_from_workflow

**Intent:** generate_sop_from_workflow  
**Intent Type:** `generate_sop_from_workflow`  
**Journey:** Journey Journey Workflow Sop Conversion (`journey_journey_workflow_sop_conversion`)  
**Realm:** Journey Realm  
**Status:** IN PROGRESS  
**Priority:** PRIORITY 1
...
- **Produced By:** `{ intent: "generate_sop_from_workflow", execution_id: "<execution_id>" }`
...
```json
{
  ...
  "error_code": "ERROR_CODE",
  "execution_id": "exec_abc123",
  "intent_type": "generate_sop_from_workflow"
}
```
