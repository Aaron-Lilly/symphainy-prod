# Intent Contract: save_parsed_content

**Intent:** save_parsed_content  
**Intent Type:** `save_parsed_content`  
...
- **Produced By:** `{ intent: "save_parsed_content", execution_id: "<execution_id>" }`
...
```json
{
  ...
  "error_code": "ERROR_CODE",
  "execution_id": "exec_abc123",
  "intent_type": "save_parsed_content"
}
```
