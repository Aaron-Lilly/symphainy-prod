# Intent Contract: save_blueprint

**Intent:** save_blueprint  
**Intent Type:** `save_blueprint`  
**Journey:** Journey Journey Create Coexistence Blueprint (`journey_journey_create_coexistence_blueprint`)  
**Realm:** Journey Realm  
**Status:** IN PROGRESS  
**Priority:** PRIORITY 1
...
- **Produced By:** `{ intent: "save_blueprint", execution_id: "<execution_id>" }`
