# Intent Contract: chat_with_journey_agent

**Intent:** chat_with_journey_agent  
**Intent Type:** `chat_with_journey_agent`  
**Journey:** Journey Journey Sop Creation Chat (`journey_journey_sop_creation_chat`)  
**Realm:** Journey Realm  
**Status:** IN PROGRESS  
**Priority:** PRIORITY 1
...
- **Produced By:** `{ intent: "chat_with_journey_agent", execution_id: "<execution_id>" }`
...
```json
{
  ...
  "error_code": "ERROR_CODE",
  "execution_id": "exec_abc123",
  "intent_type": "chat_with_journey_agent"
}
```
