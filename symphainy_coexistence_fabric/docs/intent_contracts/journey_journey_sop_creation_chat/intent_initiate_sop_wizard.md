# Intent Contract: initiate_sop_wizard

**Intent:** initiate_sop_wizard  
**Intent Type:** `initiate_sop_wizard`  
...
- **Produced By:** `{ intent: "initiate_sop_wizard", execution_id: "<execution_id>" }`
...
```json
{
  ...
  "error_code": "ERROR_CODE",
  "execution_id": "exec_abc123",
  "intent_type": "initiate_sop_wizard"
}
```
