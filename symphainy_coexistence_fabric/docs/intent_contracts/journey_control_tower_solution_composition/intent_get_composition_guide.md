# Intent Contract: get_composition_guide

**Intent:** get_composition_guide  
**Intent Type:** `get_composition_guide`  
...
- **Produced By:** `{ intent: "get_composition_guide", execution_id: "<execution_id>" }`
...
```json
{
  ...
  "error_code": "ERROR_CODE",
  "execution_id": "exec_abc123",
  "intent_type": "get_composition_guide"
}
```
