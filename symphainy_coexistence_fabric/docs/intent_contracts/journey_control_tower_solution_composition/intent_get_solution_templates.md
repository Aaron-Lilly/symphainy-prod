# Intent Contract: get_solution_templates

**Intent:** get_solution_templates  
**Intent Type:** `get_solution_templates`  
...
- **Produced By:** `{ intent: "get_solution_templates", execution_id: "<execution_id>" }`
