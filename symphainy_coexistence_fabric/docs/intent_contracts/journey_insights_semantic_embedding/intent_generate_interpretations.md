# Intent Contract: generate_interpretations

**Intent:** generate_interpretations  
**Intent Type:** `generate_interpretations`  
...
- **Produced By:** `{ intent: "generate_interpretations", execution_id: "<execution_id>" }`
...
```json
{
  ...
  "error_code": "ERROR_CODE",
  "execution_id": "exec_abc123",
  "intent_type": "generate_interpretations"
}
```
