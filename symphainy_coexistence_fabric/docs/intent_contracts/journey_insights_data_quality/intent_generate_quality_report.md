# Intent Contract: generate_quality_report

**Intent:** generate_quality_report  
**Intent Type:** `generate_quality_report`  
**Journey:** Journey Insights Data Quality (`journey_insights_data_quality`)  
...
- **Produced By:** `{ intent: "generate_quality_report", execution_id: "<execution_id>" }`
...
```json
{
  ...
  "error_code": "ERROR_CODE",
  "execution_id": "exec_abc123",
  "intent_type": "generate_quality_report"
}
```
