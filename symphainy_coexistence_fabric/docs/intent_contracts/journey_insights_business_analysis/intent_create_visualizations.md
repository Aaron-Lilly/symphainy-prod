# Intent Contract: create_visualizations

**Intent:** create_visualizations  
**Intent Type:** `create_visualizations`  
...
- **Produced By:** `{ intent: "create_visualizations", execution_id: "<execution_id>" }`
...
```json
{
  ...
  "error_code": "ERROR_CODE",
  "execution_id": "exec_abc123",
  "intent_type": "create_visualizations"
}
```
