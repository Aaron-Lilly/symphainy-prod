# Intent Contract: generate_business_insights

**Intent:** generate_business_insights  
**Intent Type:** `generate_business_insights`  
**Journey:** Journey Insights Business Analysis (`journey_insights_business_analysis`)  
...
- **Produced By:** `{ intent: "generate_business_insights", execution_id: "<execution_id>" }`
...
```json
{
  ...
  "error_code": "ERROR_CODE",
  "execution_id": "exec_abc123",
  "intent_type": "generate_business_insights"
}
```
