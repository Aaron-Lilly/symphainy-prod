...
class TestPOCProposalJourneyStructure:
    """Test POCProposalJourney structure."""
    
    def test_journey_exists(self, outcomes_solution):
        """POCProposalJourney should exist."""
        journey = outcomes_solution.get_journey("poc_proposal")
...
class TestPOCProposalJourneyExecution:
...
class TestPOCProposalJourneySOAAPIs:
