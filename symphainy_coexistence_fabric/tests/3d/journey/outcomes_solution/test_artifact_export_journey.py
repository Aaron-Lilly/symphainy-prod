...
class TestArtifactExportJourneyStructure:
    """Test ArtifactExportJourney structure."""
    
    def test_journey_exists(self, outcomes_solution):
        """ArtifactExportJourney should exist."""
        journey = outcomes_solution.get_journey("artifact_export")
...
class TestArtifactExportJourneyExecution:
    """Test ArtifactExportJourney execution."""
...
class TestArtifactExportJourneySOAAPIs:
    """Test ArtifactExportJourney SOA APIs."""
