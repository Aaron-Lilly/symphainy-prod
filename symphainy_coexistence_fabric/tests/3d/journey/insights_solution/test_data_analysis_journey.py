...
class TestDataAnalysisJourneyStructure:
    """Test DataAnalysisJourney structure."""
    
    def test_journey_exists(self, insights_solution):
        """DataAnalysisJourney should exist."""
        journey = insights_solution.get_journey("data_analysis")
...
class TestDataAnalysisJourneyExecution:
...
class TestDataAnalysisJourneySOAAPIs:
    """Test DataAnalysisJourney SOA APIs."""
