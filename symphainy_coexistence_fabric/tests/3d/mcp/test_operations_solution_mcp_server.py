...
class TestOperationsSolutionMCPServer:
    """Test OperationsSolution MCP Server."""
    ...
    @pytest.mark.asyncio
    async def test_mcp_server_has_tools(self, operations_solution):
    ...
    def test_soa_apis_exposed(self, operations_solution):
        """Solution should expose SOA APIs."""
        apis = operations_solution.get_soa_apis()
