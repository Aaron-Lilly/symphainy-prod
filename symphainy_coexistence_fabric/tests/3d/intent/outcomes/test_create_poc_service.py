...
class TestCreatePOCParameters:
    """Test create_poc parameter validation."""
    ...
    def test_requires_parameters(self):
        ...
        assert intent.intent_type == "create_poc"


class TestCreatePOCExecution:
    """Test create_poc execution."""
