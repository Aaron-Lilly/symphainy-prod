...
class StateSurface:
    ...
    async def register_artifact(
        ...
        Delegates to ArtifactRegistry.register_artifact().
    ...
    async def resolve_artifact(
        ...
        Delegates to ArtifactRegistry.resolve_artifact().
    ...
    async def add_materialization(
        ...
        Delegates to ArtifactRegistry.add_materialization().
        ...
        Returns:
            True if successful
        """
        return await self.artifact_registry.add_materialization(
            artifact_id=artifact_id,
            tenant_id=tenant_id,
            materialization=materialization
        )
    ...
    async def update_artifact_lifecycle(
        ...
        Delegates to ArtifactRegistry.update_artifact_lifecycle().
        ...
        Returns:
            True if successful
        """
        return await self.artifact_registry.update_artifact_lifecycle(
            artifact_id=artifact_id,
            tenant_id=tenant_id,
            new_state=new_state,
            reason=reason
