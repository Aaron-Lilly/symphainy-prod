...
def trace_callers():
    ...
    return [
        ("service_factory.py", "create_runtime_services", "public_works = PublicWorksFoundationService(config); get_state_abstraction(), get_file_storage_abstraction(), get_wal_backend(), get_registry_abstraction(), get_artifact_storage_abstraction() passed to StateSurface, WAL, ELM, RuntimeServices"),
