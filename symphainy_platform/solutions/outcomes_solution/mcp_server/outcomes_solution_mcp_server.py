"""Outcomes Solution MCP Server - Tool naming: outcomes_{action}"""
...
class OutcomesSolutionMCPServer(MCPServerBase):
    def __init__(self, solution, public_works: Optional[Any] = None, state_surface: Optional[Any] = None):
        super().__init__(service_name="outcomes_solution_mcp", realm_name="outcomes")
    ...
    def get_usage_guide(self) -> Dict[str, Any]:
        return {"server_name": "outcomes_solution_mcp", "journeys": self._registered_journeys, "tools": list(self.soa_api_registry.values())}
