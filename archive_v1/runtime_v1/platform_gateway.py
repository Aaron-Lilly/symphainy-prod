...
class PlatformGateway:
    ...
    def get_file_storage_abstraction(self) -> Optional[Any]:
        ...
        Returns:
            FileStorageAbstraction or None
        """
        if self.public_works:
            return self.public_works.get_file_storage_abstraction()
        return None
    ...
    def get_ingestion_abstraction(self) -> Optional[Any]:
        ...
        Returns:
            IngestionAbstraction or None
        """
        if self.public_works:
            return self.public_works.get_ingestion_abstraction()
        return None
