...
Parses PDF files using appropriate abstraction.
"""
...
class PDFParser:
    ...
    Parses PDF files using PDF Processing Abstraction.
    """
        ...
        try:
            ...
            if not abstraction:
                return ParsingResult(
                    success=False,
                    error="PDF Processing Abstraction not available",
    ...
    async def _get_abstraction(self) -> Optional[Any]:
        """Get PDF Processing Abstraction via Platform Gateway."""
        ...
        try:
            ...
            self.logger.error(f"Failed to get PDF abstraction: {e}")
            return None
