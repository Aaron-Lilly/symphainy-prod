...
@pytest.fixture
def journey_solution(mock_public_works, mock_state_surface):
    """JourneySolution instance."""
    from symphainy_platform.solutions.journey_solution import JourneySolution
    return JourneySolution(
        public_works=mock_public_works,
        state_surface=mock_state_surface
    )
